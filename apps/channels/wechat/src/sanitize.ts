 ...
 * chain-of-thought as body text. Delivered verbatim, WeChat (which renders
 * plain text) shows it one word per line ("一行一行"). This reflows that
 * pathological word-per-line pattern back into normal text and strips any
 * reasoning-tag wrappers, while leaving genuinely paragraph-/list-formatted
 * replies untouched.
 */
